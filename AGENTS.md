...
- Context root: `/home/user/Repositories/robotic-property-photographer`
- n8n version at generation time: 2.19.5
...
```bash
cd /home/user/Repositories/robotic-property-photographer
