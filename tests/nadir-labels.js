...
const TEST_PAYLOAD = {
    ...
    "order_id": "test_nadir_labels",
    "shots": ["nadir"],
    "capabilities": ["labels"]  // Only render transparent street labels 
};

console.log("\n🚀 Testing ISOLATED CAPABILITY: Nadir Street Labels...");
...
async function run() {
    try {
        ...
        console.log("\n📋 Check the output. It should be a single transparent PNG containing ONLY the street text rotated to align with the unrendered road geometry, without any map imagery.");
